	...
	return (
		<>
			<main className="grid grid-cols-2 grid-rows-3 gap-4 justify-between overflow-hidden">
				<div>
					<div className="mb-4">Доступна для сотрудничества - Минск, Беларусь</div>
					<h2 className="font-bold text-4xl">
						Frontend
						<span className="text-yellow-600">&nbsp;Разработчик</span>
					</h2>
					<div className="mt-4 text-2xl text-amber-950">
				...
				<div className="relative justify-self-end mb-8">
					...
					/>
					<span className="absolute text-focus rounded-sm bg-accent bottom-0 right-0 text-xs font-bold px-2.5 py-1 border-2 border-gray-700 animate-wiggle">3 года опыта</span>
				</div>
				<div className="col-span-2">
					<h4 className="flex self-center justify-center mb-8">Стек технологий</h4>
